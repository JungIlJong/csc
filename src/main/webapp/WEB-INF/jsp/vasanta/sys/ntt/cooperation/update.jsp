                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <div class="form-control-validation fv-plugins-icon-container">
                                                            <div class="flex-c gap-2">
                                                                <div class="has-validation w-100">
                                                                    <input class="form-control" type="text" name="insert_dt"
                                                                           id="insert_dt" placeholder="등록일">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <div class="form-control-validation fv-plugins-icon-container">
                                                            <div class="flex-c gap-2">
                                                                <div class="has-validation w-100">
                                                                    <input class="form-control" type="text" name="wrter_nm"
                                                                           id="wrter_nm" placeholder="이름">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </td>
...
<script>
    ...
    $(function () {
        ...
        let setDetail = function (data) {
            ...
            $('#insert_dt').val(formatDateToYMD(data.frstRegiminDate));
            $('#wrter_nm').val(data.wrterNm);
