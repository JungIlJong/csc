                    ...
                    if (parseInt(request.result)) {
                        if (request.data) {
                            ...
                            if (detail_img_list.length > 0) {
                                ...
                                let youtube_url = request.data[0].youtube_url;
                                youtube_url = youtube_url.substring(youtube_url.lastIndexOf('/') + 1);

                                player = new YT.Player('player', {
                                    height: '390', // 높이
                                    width: '640', // 너비
                                    videoId: youtube_url, // 영상ID
                            ...
                            if (request.result == "1") {
                                ...
                                for (i = 0; i < request.data.length; i++) {
                                    if (request.data[i].view_type == "prev") {
                                        ...
                                        $("#prev_post_href").attr("href", "/customer/press-video-view?board_type=" + request.data[i].board_type + "&board_no=" + request.data[i].board_no);
                                    } else {
                                        $('#next_post').text(request.data[i].board_title);
                                        $("#next_post_href").attr("href", "/customer/press-video-view?board_type=" + request.data[i].board_type + "&board_no=" + request.data[i].board_no);
                                    }
                                }
                            }
                        }
    ...
    <div class="contents">
        <div class="recruit-news view">
            ...
            <div class="btn-row-right">
                <a href="/customer/press-video?board_type=<%=request.getParameter("board_type") %>">
...
<!-- //main -->
<div id="footer"></div>
<div class="btn-top">TOP<p class="top-line"></p>
</div>
