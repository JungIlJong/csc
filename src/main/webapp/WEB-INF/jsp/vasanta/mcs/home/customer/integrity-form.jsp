		...
		grecaptcha.ready(function() {
	          grecaptcha.execute('6Le8_iQcAAAAACCuc_W--e48akBOB61Uzu839PkO', {action: 'submit'}).then(function(token) {
	    	 	...
	    	 	if(!pattern.test(mail)){
	    	 		alert("이메일 형식이 맞지 않습니다. 확인해주세요.");return;
	    	 	}
	    		...
	    		if($('#board_pwd').val() != $('#board_re_pwd').val()){
	    			...
	    			formData.append("name", $.cookie('authorName'));
	    			formData.append("email", $('#email').val());
	    			formData.append("phone", $.cookie('authorHp'));
  ...
  <main class="customer-main">
    <div class="page-tit">
      ...
      <ul class="rocation">
        ...
        <li>
          <a href="/mber/customer/opinion-agree">고객소통</a>
        </li>
        <li>청렴·부패 신고</li>
      </ul>
    </div>
      ...
      <div class="conts-ani" data-trigger>
        ...
        <form action="" enctype="multipart/form-data">
          <ul class="board-form">
            ...
            <li class="board-form-email">
              <div class="board-form-tit">이메일</div>
              <div class="board-form-conts">
                <input type="text" id="email" class="input-style" placeholder="이메일을 입력해주세요" maxlength="30">
              </div>
            </li>
            <li>
