...
<%
    ...
    String sReturnUrl = "https://www.kepcomcs.co.kr/checkplus_integrity_success";      // 성공시 이동될 URL
  ...
  <main class="customer-main">
    ...
    <div class="contents"> 
      <div class="conts-ani" data-trigger>
        <p class="conts-desc_01 txt-ac tdesc">투명한 경영을 위해 비리 및 부정 신고를 받는 청렴·부패 신고 접수 창구입니다.</p>
