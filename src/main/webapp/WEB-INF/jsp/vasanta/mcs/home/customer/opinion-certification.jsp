...
//    sRequestNumber = niceCheck.getRequestNO(sSiteCode);
    ...
    String sReturnUrl = "https://www.kepcomcs.co.kr/checkplus_opinion_success";      // 성공시 이동될 URL
    String sErrorUrl = "https://www.kepcomcs.co.kr/checkplus_fail";
