...
<script>
		...
		function getPowerRegion1()
		{
			var datalist = [];
			var param = {};
			
			var request = postAjax("/get/power/region/1",param);
			if(request.result == '1')
			{
		...
		function getPowerRegion2()
		{
			...
			var request = postAjax("/get/power/region/2",param);
			if(request.result == '1')
			{
				datalist = request.data;
			}
