...
<head>
  ...
  <script type="text/javascript">
  	...
  	var setBoardType = <%=request.getParameter("board_type") %> ? <%=request.getParameter("board_type") %> : 27;
		         ...
		         success: function (data) {
		         	...
		         	if(parseInt(data.result))
		     		{
		         		...
		         		for ( i = 0; i < data.data.length; i++) {
							...
							li_html = li_html + "<a href='/customer/press-news-view?board_type="+setBoardType+"&board_no=" + data.data[i].board_no +"'>";
...
<body id="mcsPage">
  ...
  <main class="customer-main">
    ...
    <!-- 230720 원본소스 주석처리 후 탭 추가 -->
      ...
      <div class="conts-ani" data-trigger>
        <p class="conts-desc_01 txt-ac tdesc">한전MCS의 뉴스레터</p>
